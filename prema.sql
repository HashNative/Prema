...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2019 at 06:42 AM
...
(1, 'Tester', '7856908-9', 'kinniya', '2000', 'true');
...
INSERT INTO `invoice` (`No`, `ino`, `Date`, `Customer`, `Plate_no`, `Product`, `first_weight`, `second_weight`, `net_weight`, `intime`, `outtime`, `amount`, `total`, `discount`, `net_total`, `payment_method`, `user`, `paid`, `due`) VALUES
